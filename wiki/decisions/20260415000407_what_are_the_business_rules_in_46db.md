---
title: "Decision - what are the business rules in portfolio"
summary: "Archived decision for query: what are the business rules in portfolio"
created: 2026-04-14T16:04:07.482Z
modified: 2026-04-14T16:04:07.482Z
...
# Decision - what are the business rules in portfolio

## Summary
Archived decision for query: what are the business rules in portfolio
...
### Question
what are the business rules in portfolio?

### Conversation

**User:** what are the business rules in portfolio?
...
- Phase 1.1: COBOL Analysis Report IPMS Discovery Phase | Portfolio Management System Execution Date: 11 April 2026 Status: ✅ COMPLETE Coverage: 100% (38 programs, 20 copybooks, 5 DB2 tables) Overall Confidence: 93% average --- Executive Summary Phase 1.1 successfully completed comprehensive static analysis of the IPMS COBOL/CICS/DB2 environment.
- This foundational phase maps all data lineage, validates copybook-to-DB2 parity, extracts business rules, and defines the semantic boundary contexts for downstream phases.
- DB2SCHEMAANALYSIS — 5 tables (PORTFOLIOMASTER, TRANSACTIONHISTORY, POSITIONHISTORY, ERRLOG, RTNCODES) with column-to-copybook mappings 4.

**Conflicts**

- Phase 1.2.1: IPMS Business Glossary Extraction and Phase 1.1: COBOL Analysis Report provide conflicting guidance about what are the business rules in portfolio?. Sources: 

**Coverage Gaps**

- The available evidence conflicts, so the answer includes the most defensible position but cannot fully resolve the disagreement. Review the cited sources for "what are the business rules in portfolio?" to determine which guidance should be treated as authoritative.
...
- Supporting wiki pages: Phase 1.2.1: IPMS Business Glossary Extraction, Phase 1.1: COBOL Analysis Report, Phase 1.2.2: IPMS Semantic Ontology (OWL-DL), Phase 1.5: Quick Reference & Navigation Guide, Phase 1.5: Data Quality Dimension Analysis for IPMS

## Metadata
- **Archived**: 2026-04-14T16:04:07.482Z
