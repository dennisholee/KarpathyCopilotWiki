...
created: 2026-04-14T16:18:30.240Z
modified: 2026-04-14T16:18:30.240Z
...
The **Transaction** entity is documented as an immutable event log with these core data points: **TRANSACTIONID, TRANSACTIONDATE, TRANSACTIONTIME, TRANSACTIONTYPE, INVESTMENTID, QUANTITY, PRICE, AMOUNT, CURRENCYCODE, TRANSACTIONSTATUS, PROCESSTIMESTAMP,** and **PROCESSUSER**. The glossary also notes **Transaction Key** as a synonym for **TRANSACTIONID**, **Transaction Record** as the full entity structure, and transaction type values **BU, SL, TR,** and **FE**; for **QUANTITY**, a separate data quality note flags a precision mismatch risk across COBOL/DB2 representations.
...
## Metadata
- **Archived**: 2026-04-14T16:18:30.240Z
