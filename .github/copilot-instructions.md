...
- 004-add-raw-subdirs: Added TypeScript 5.x on Node.js via VS Code extension runtime (`ES2020`, VS Code `^1.80.0`) + `vscode`, existing `WikiManager`, `IngestOrchestrator`, `ExtractionService`, `markdown-it`, `markdown-it-wikilinks`, `pdfjs-dist`, existing markdown/frontmatter utilities
